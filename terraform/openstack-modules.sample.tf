...
# create floating ip for use with control load balancer - uncomment to use
/*
...
# create neutron lb (via lbaas) for control nodes - uncomment to use
/*
module "control-lb" {
...
# create floating ip for use with edge load balancer - uncomment to use
/*
...
# create neutron lb (via lbaas) for edge nodes - uncomment to use
/*
module "edge-lb" {
  source = "./terraform/openstack/lbaas"
  name = "${var.name}"
